  ...
  <h2 className="text-2xl font-bold tracking-tight text-gray-900"></h2>
    ...
    {getProducts.data && getProducts.data.map((products)=>{
      ...
      <div className="group relative" key={products.product_id}>
        ...
        <img src={`http://localhost:4200/uploads/${products.product_image}`} alt="Front of men's Basic Tee in black." className="h-full w-full object-cover object-center lg:h-full lg:w-full" />
        </div>
        <div className="mt-4 flex justify-between">
          ...
          <p className="text-sm font-medium text-gray-900">Rs.{products.product_price}</p>
