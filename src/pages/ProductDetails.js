    ...
    <div className="flex flex-col md:flex-row -mx-4">
      ...
      <div className="md:flex-1 px-4">
        <div className="h-[460px] rounded-lg bg-gray-300 mb-4">
          <img className="w-full h-full object-cover" src={`http://localhost:4200/uploads/${Details.product_image}`} alt="Product Image" />
        </div>
...
<button onClick={(e)=>{addToCart(e,Details)}} className="w-full bg-gray-900 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800">Add to Cart</button>
        ...
        <div className="flex mb-4">
          <div className="ml-15 mx-auto text-center">
